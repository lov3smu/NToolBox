...
export const generateScript = safeApiCall(api.generateScript, {
  success: false,
...
export const readDirectory = safeApiCall(api.readDirectory, {
  success: false,
  error: 'API not available'
})
export const copyToClipboard = safeApiCall(api.copyToClipboard, false)
export const getItemInfo = safeApiCall(api.getItemInfo, {
  success: false,
  error: 'API not available'
})
export const chat = safeApiCall(api.chat, { success: false, error: 'API not available' })
export const chatStream = safeApiCall(api.chatStream, {
  success: false,
  error: 'API not available'
})
...
export const dbTestConnection = safeApiCall(api.dbTestConnection, {
  success: false,
  error: 'API not available'
})
export const dbCreateConnection = safeApiCall(api.dbCreateConnection, {
  success: false,
  error: 'API not available'
})
export const dbCloseConnection = safeApiCall(api.dbCloseConnection, {
  success: false,
  error: 'API not available'
})
export const dbCloseAllConnections = safeApiCall(api.dbCloseAllConnections, {
  success: false,
  error: 'API not available'
})
export const dbExecuteQuery = safeApiCall(api.dbExecuteQuery, {
  success: false,
  error: 'API not available'
})
export const dbQueryDatabases = safeApiCall(api.dbQueryDatabases, {
  success: false,
  error: 'API not available'
})
export const dbQueryTables = safeApiCall(api.dbQueryTables, {
  success: false,
  error: 'API not available'
})
export const dbGetTableStructure = safeApiCall(api.dbGetTableStructure, {
  success: false,
  error: 'API not available'
})
...
export const dbBeginTransaction = safeApiCall(api.dbBeginTransaction, {
  success: false,
  error: 'API not available'
})
export const dbCommitTransaction = safeApiCall(api.dbCommitTransaction, {
  success: false,
  error: 'API not available'
})
export const dbRollbackTransaction = safeApiCall(api.dbRollbackTransaction, {
  success: false,
  error: 'API not available'
})
